...
public interface Users {
	 ...
	 * @return OK, the userId.
	 *         CONFLICT if the user id already exists. 
	 ...
	 * @return OK the user object, if the userId exists and password matches the existing
	 *         password
	 ...
	 * @return OK the updated user object, if the name exists and password matches the
	 *         existing password 
	 *         FORBIDDEN if the password is incorrect
	 *         NOT_FOUND if no user exists with the provided userId
	 *         BAD_REQUEST otherwise.
	 ...
	 * @param password password of the user
	 * @return OK the deleted user object, if the name exists and pwd matches the
	 *         existing password 
	 *         FORBIDDEN if the password is incorrect
	 *         NOT_FOUND if no user exists with the provided userId
	 */
